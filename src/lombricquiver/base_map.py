...
def create_layer_base(dict_extract_var, var_heatmap = 'wind_speed', dpi=300, height_inches=9,
                      file_name: str = 'base_layer.png',
                      crs_transform=ccrs.PlateCarree(), cmap='plasma_r', 
    ...
    Parameters:
    dict_extract_var (dict): Dictionary containing at least 'long', 'lat', and a variable to be plot. (e.g wind_speed).
